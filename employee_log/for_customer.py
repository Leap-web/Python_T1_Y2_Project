...
class User:
    ...
    def usage_menu(self):
        while True:
            print("\n==============================Usage Menu==============================")
            print("1. Browse items in the stock")
    ...
    def browse_item(self):
        stock_menu()  # Calling stock_menu() from stock.py

    def order_history(self):
        show_total()  # Calling show_total() from stock.py


if __name__ == '__main__':
    user_filename = "/Users/savonchanserey/Desktop/my-repo/Employees/customer_pw.txt" 
    balance_filename = "/Users/savonchanserey/Desktop/my-repo/Employees/customer_balance.txt" 
    user = User(user_filename, balance_filename)
    user.usage_menu()
